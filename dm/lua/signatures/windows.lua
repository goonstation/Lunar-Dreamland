...
sigscan(
	"ResumeIn2",
	"ResumeIn2",
	"55 8B EC 53 56 57 8B 7D 08 57 E8 ?? ?? ?? ?? 8B 1F 8B F0 8A 4F 63 83 C4 04 8B 56 18 88 4A 63 8B 4B 20 89 4E 20 8B 43 24 89 46 24 8B 45 0C C6 47 63 00 C7 43 ?? ?? ?? ?? ?? C7 43 ?? ?? ?? ?? ?? 8B 4E 18 89 41 04 F6 43 04 10"
)

sigscan(
	"StartTiming",
	"StartTiming",
	"55 8B EC 56 8B 75 08 56 80 4E 04 04 E8 ?? ?? ?? ?? 8B ?? ?? ?? ?? ?? 83 C4 04 3B ?? ?? ?? ?? ?? 73 0A A1 ?? ?? ?? ?? 8B 04 88 EB 02 33 C0 3B F0"
)
